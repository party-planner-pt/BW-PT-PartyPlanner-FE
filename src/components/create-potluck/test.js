...
const formikHOC = withFormik({
  ...
  validationSchema: Yup.object().shape({
    name: Yup.string().required('I said enter your name'),
    email: Yup.string().email('wtf is this?').required('You forgot your email'),
    password: Yup.string().required('Make it smart this time'),
